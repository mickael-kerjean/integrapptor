      ...
      <header id="tabs">
          <div class="no-select flex">
              ...
              <div id="action_button">
                  <img id="navigate_backward_inactive" src="./assets/icons/icon_left_inactive.png"/>
                  <img class="hide" id="navigate_backward" src="./assets/icons/icon_left.png"/>
                  <img id="navigate_forward_inactive" src="./assets/icons/icon_right_inactive.png"/>
                  <img class="hide" id="navigate_forward" src="./assets/icons/icon_right.png"/>
                  <img id="refresh" src="./assets/icons/icon_refresh.png"/>
              </div>
          </div>
          <div id="menu-content">
